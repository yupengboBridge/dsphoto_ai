...
//$private_key = "/home2/chroot/home/xhankyu/.ssh/id_xhankyu_nopass";
...
exec($com.' 2>&1',$ans);
	...
	$filename = "putxml_xml.log";
	$home2_log_dir = "/home2/chroot";
	//$home2_log_dir = "";
	$log_dir = $xRootPath."log/";
...
// /*
// $DRoot = '/home2/chroot/home/xhankyu/public_html/photo_db/';
// $local_csv_dir = $DRoot . "makexml_for_test/csv";
// $local_xml_dir = $DRoot . "makexml_for_test/xml";
// $local_xml_dir2 = $DRoot . "makexml_for_test/xml/hotel";
// */
// /*検証機だけど本物ｘｍｌ置き場 らくらく用*/
...
// /*検証機で検証環境のｘｍｌ置き場*/
// $remot_csv_dir = "/var/wb/export_staging/protected/users/itec-test/master_data/xml_test";
// $remot_csv_dir2 = "/var/wb/export_staging/protected/users/itec-test/master_data/xml_test/xml";
