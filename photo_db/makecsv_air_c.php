...
$s_file_head = "\"departure_place\",\"web_city_name\",\"destination_code\",\"destination_name\",\"country_code\",\"country_name\",\"city_code\",\"city_name\",\"carr_code\",\"carr_name\"";

try
{
	$s_csv_content .= $s_file_head;
	$s_csv_content .= base64_decode("DQo=");
	$xml = simplexml_load_file($xmldir."air_carr_list.xml");
	...
	// CSVファイルを出力する
	$file = fopen($csvdir."air_carr_list.csv","w");
