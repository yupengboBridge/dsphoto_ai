...
function showDataList()
{
	...
	try
	{
		$file = @file($csvdir."i_p_country_url.csv");
		// ファイルは見つからない場合
		if (!$file)
		{
			// エラーメッセージを表示する
			print "<script type=\"text/javascript\">";
			print "alert(\"「i_p_country_url.csv」CSVファイルは見つかりません。ご確認ください。\");";
		...
		// CSVファイルを開く
		$file = fopen($csvdir."i_p_country_url.csv","r");
		// ファイルオープンエラー
		if (!$file)
		{
			// エラーメッセージを表示する
