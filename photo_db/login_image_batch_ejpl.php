...
function uploadfiles()
{
	...
	//		}
		...
		$tmpfilename = "./ejpl/".$csv_content[0];
		if (!is_file($tmpfilename))
		{
			$errmessage = "画像ファイル：".$csv_content[0].",ejplディレクトリに見つかりませんでした。,".date("Y-m-d H:i:s")."\r\n";
			$str =  "<p style='color: red'>"."画像ファイル：".$csv_content[0]."はejplディレクトリに見つかりませんでした。</p>";
