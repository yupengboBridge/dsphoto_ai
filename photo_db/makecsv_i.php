...
$s_file_head = "\"departure_place_no\",\"departure_place_name\",\"destination_code_para\",\"destination_name\",\"country_code_para\",\"country_name\",\"city_code_para\",\"city_name\"";

try
{
	$s_csv_content .= $s_file_head;
	$s_csv_content .= base64_decode("DQo=");
	$xml = simplexml_load_file($xmldir."ab_destination_list.xml");
	...
	// CSVファイルを出力する
	$file = fopen($csvdir."ab_destination_list.csv","w");
