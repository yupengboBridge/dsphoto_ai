...
function uploadfiles($csvcontent,$s_logininfo)
{
	...
	file_put_contents('/home/xhankyu/public_html/photo_db/20230301c.txt', $csvcontent,FILE_APPEND);
	...
	file_put_contents('/home/xhankyu/public_html/photo_db/20230301ca.txt', $csv_content,FILE_APPEND);
	// csvcontent
	//echo $csvcontent;
	//
	//データ
