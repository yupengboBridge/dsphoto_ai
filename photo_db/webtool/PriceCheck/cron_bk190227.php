...
class priceCheckCron{
	...
	function __construct($flg,$naigai) {
		...
		$this->outfileAryD ='trabid_d_kw.xlsx';
		$this->outfileAryBus ='bus_geofeed.xlsx';
		$this->outfileAryTaiwan ='taiwan_area_trabid_i.xlsx';
		$this->outfileAryKorea ='korea_area_trabid_i.xlsx';
		$this->outfileAryHawaii ='hawaii_area_trabid_i.xlsx';
		...
		$isExlI = '/home/xhankyu/public_html/photo_db/webtool/PriceCheck/outdata/trabid_i.xlsx';
		$isExlD = '/home/xhankyu/public_html/photo_db/webtool/PriceCheck/outdata/trabid_d_kw.xlsx';
		$isExlBus ='/home/xhankyu/public_html/photo_db/webtool/PriceCheck/outdata/bus_geofeed.xlsx';
		$isExlTaiwan = '/home/xhankyu/public_html/photo_db/webtool/PriceCheck/outdata/taiwan_area_trabid_i.xlsx';
		$isExlKorea = '/home/xhankyu/public_html/photo_db/webtool/PriceCheck/outdata/korea_area_trabid_i.xlsx';
		$isExlHawaii = '/home/xhankyu/public_html/photo_db/webtool/PriceCheck/outdata/hawaii_area_trabid_i.xlsx';
	...
	function DirCleanling(){
		...
		foreach (glob($path) as $filename) {
			...
			if($ymd !='trabid_d' && $ymd !='bid_d_kw' && $ymd !='trabid_i' && $ymd !='_geofeed'){
...
Class TsvUproad{
	function __construct(){
		...
		/*$this->outfileAryI ='trabid_i.xlsx';
		//$this->outfileAryDend ='trabid_d.xlsx';
		$this->outfileAryD ='trabid_d_kw.xlsx';
		$this->outfileAryBus ='trabid_d.xlsx';
		$this->outfileAryTaiwan ='taiwan_area_trabid_i.xlsx';*/
	...
	function FTP_Up($Type){
		...
		if ($handle = opendir($this->TgLocalDir)) {
			...
			*/
				...
				if(stripos($file,'trabid_d_kw.xlsx')!==false){
				...
				if(stripos($file,'taiwan_area_trabid_i.xlsx')!==false){
					ftp_put($this->conn_id, $file, $this->TgLocalDir.$file,FTP_BINARY);
				}
				if(stripos($file,'korea_area_trabid_i.xlsx')!==false){
					ftp_put($this->conn_id, $file, $this->TgLocalDir.$file,FTP_BINARY);
				}
				if(stripos($file,'hawaii_area_trabid_i.xlsx')!==false){
					ftp_put($this->conn_id, $file, $this->TgLocalDir.$file,FTP_BINARY);
				}
