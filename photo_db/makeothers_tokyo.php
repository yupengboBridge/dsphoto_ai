...
$MyMainDir = $xRootPath . 'others/tokyo/';
/*ディレクトリ*/
...
//				if($data[0] != $FlgHatsu){
				...
				if($Naigai == 'i'){
					...
					$PageName = !empty($FileNameAry[$Naigai][$DestCode])?$FileNameAry[$Naigai][$DestCode]:"";
