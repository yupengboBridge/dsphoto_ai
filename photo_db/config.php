<?php
//require_once dirname(__FILE__).'/exceptionHandle.php';
// config.php
...
$upload_conf['maxsize'] = 5000000;										// アップロードファイルの制限サイズ
$upload_conf['site_url'] = $site_url;									// サイトURL

$csv['local_export_dir'] = './csv1/';
...
$font_name_batch = "/data/photo_db/sazanami-gothic.ttf";
