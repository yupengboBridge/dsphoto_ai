...
function uploadfiles()
{
	...
	//		}
		...
		$tmpfilename = "./ejdi/".$csv_content[0];
		if (!is_file($tmpfilename))
		{
			$errmessage = "画像ファイル：".$csv_content[0].",ejdiディレクトリに見つかりませんでした。,".date("Y-m-d H:i:s")."\r\n";
			$str =  "<p style='color: red'>"."画像ファイル：".$csv_content[0]."はedjiディレクトリに見つかりませんでした。</p>";
