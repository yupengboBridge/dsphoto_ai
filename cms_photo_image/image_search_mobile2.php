...
$back = ini_get('user_agent');
header("Content-type: image/jpeg; charset=UTF-8");
$binary = file_get_contents("https://x.hankyu-travel.com/photo_db/./thumb2/8/20081216182310624th2.jpg");
//ini_set('user_agent', $back);
echo $binary;

//// データーベース情報です
////$db_host = '10.254.1.123';
//$db_host = 'localhost';
//$db_user = '_ximage';
////$db_user = 'ximage';
////$db_user = 'root';
