...
function go_search()
{
	...
	top.middle1.location.href = "./search_menu.php";
	// ピックアップ用のURLを作成します。
	// クッキー識別子を作成します。
	...
	//top.document.getElementById('iframe_middle1').style.height = "60px";
 ...
 * 戻り値：無し
 */
function go_arubamu_list()
{
	var url = "./arubamu_list.php";
	top.bottom.location = url;

	top.middle2.location = "./pickup_ichiran1.php?hide_all=1";
}
 ...
 * 戻り値：無し
 */
function go_dbmanage()
{
	top.bottom.location = "./db_managemnt.php";
}

function go_registration_permisson()
{
	top.bottom.location = "./registration_list.php";
}
	...
	<div id="header">
		<div>
			...
			<ul id="navi_menu">
				...
				<li class="permisson"><a href="#" onclick='go_registration_permisson();' title="画像登録許可" >画像登録許可</a></li>
				<li class="management"><a href="#" onclick='go_dbmanage();' title="DB管理" >DB管理</a></li>
			</ul>
			<ul id="navi">
