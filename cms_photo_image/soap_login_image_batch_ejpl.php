...
// WSDLのURL
//$wsdl = "https://".$_SERVER["SERVER_NAME"].dirname($_SERVER["PHP_SELF"])."/"."soap_login_image_batch_ejpl.wsdl";
$wsdl = "soap_login_image_batch_ejpl.wsdl";
...
{
	file_put_contents('/home/xhankyu/public_html/photo_db/soap_login_image_batch_limi.txt', 'ejpl'.PHP_EOL,FILE_APPEND);
	return "OK";
