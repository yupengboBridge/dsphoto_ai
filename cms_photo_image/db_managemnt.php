	...
	<div class="photo_pickup">
		...
		<div class="list_contents">
			...
			<table width="800" border="0" cellspacing="0" cellpadding="0" class="db_management">
				...
				<tr>
					<td class="btn dot"><label>
						<a href="./photo_no_list.php" target="bottom"><input type="button" name="button_photo_no" id="button_photo_no" value="写真番号リスト作成" onclick="document.cookie = 'photo_no_val=xx; expires=Tue, 1-Jan-1980 00:00:00;';parent.bottom.location.href='./photo_no_list.php';"/></a>
						</label></td>
					<td class="dot">すべてのデータからBUD　PHOTOの番号リストを作成する</td>

				</tr>
				<tr>
					<td class="btn dot"><input type="button" name="button2" id="button2" value="ユーザー一括登録" onclick="parent.bottom.location.href='./import_userlist.php'"/></td>
					<td class="dot">CSVでのユーザー一括登録はここから</td>
				</tr>
                <tr>
                    <td class="btn dot">
                    ...
                    <td class="dot">CMS PHOTO IMAGEのデータをダウンロードする(DS PHOTO WEBのデータは含まれない)</td>
