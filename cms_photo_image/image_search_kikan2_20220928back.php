...
$content=file_get_contents('https://xzdb.hstech-china.com/cms_photo_image/thumb1/6/20211015154310723th1.webp');
echo $content;
exit;
...
//liukeyu add strat 20110728
					...
					//yupengbo modify end 20120203
						...
						header("Content-Type:image/webp");
						$content=file_get_contents('https://xzdb.hstech-china.com/cms_photo_image/./thumb2/2/20211013163512318th2.webp');
						...
						if ($l_ext == 'jpg'){
						 ...
						 $content=file_get_contents('https://xzdb.hstech-china.com/photo_db/./thumb12/6/202110291159381096.jpg');
						 echo $content;
					}
