...
$upload_conf['maxsize'] = 10000000;										// アップロードファイルの制限サイズ
...
// WSDLのURL
//$wsdl = "https://".$_SERVER["SERVER_NAME"].dirname($_SERVER["PHP_SELF"])."/"."soap_login_image_batch_photoweb.wsdl";
$wsdl = "soap_login_image_batch_photoweb.wsdl";
...
class FileUploadBatch
{
	 ...
	 * コンストラクター
	 */
	function FileUploadBatch($fln,$cf, $thdir, $flw, $fname, $cre, $wcredit)
	{
