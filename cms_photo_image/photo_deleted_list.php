...
$dbH = mysqli_connect($db_host, $db_user, $db_password) or die('Could not connect to MySQL server.<br>' . mysql_error());
...
if(file_exists(dirname(__FILE__)."/log/delete_image.log"))
{
	...
	mysqli_query($dbH,$sql) or die('Error loading data file.<br>' . mysqli_error());
